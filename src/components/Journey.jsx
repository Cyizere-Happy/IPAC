...
const Journey = () => {
  ...
  const staticMilestones = [
    { x: 100, y: 350, labelPos: "top" },
    { x: 300, y: 280, labelPos: "bottom" },
    { x: 420, y: 200, labelPos: "top" },
    { x: 650, y: 120, labelPos: "bottom" },
  ];

  const milestones = workshops.map((w, i) => ({
    ...w,
    ...staticMilestones[i % staticMilestones.length],
    title: w.title,
    desc: w.location,
  }));
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className="w-full h-full bg-white rounded-full shadow-md border-2 border-white flex items-center justify-center transition-transform group-hover:scale-105 overflow-hidden">
                  {m.image ? (
                    <img
                ...
                >
                  <h4 className="text-xl font-bold text-black mb-1 group-hover:text-primary transition-colors">
                    {m.title}
                  </h4>
